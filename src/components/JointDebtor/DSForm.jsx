...
const DSForm = ({ document_number }) => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            // Enviar al backend
            const response = await crediexpressAPI.post("/func/create_ds", {
            ...
            if(response.data.status == "approved"){
                navigate(response.data.url_to_sign_dp)
            } else {
                toast.error("El deudor solidario no cumple con los parametros del motor.")
            }
